...
const config = {
  ...
  alipayPublicKey: formatKey(publicKey),
  notifyUrl: 'http://localhost:3000/alipay-notify', // 异步通知地址
  returnUrl: 'http://localhost:3000/return',        // 同步返回地址
  signType: 'RSA2',
  charset: 'utf-8',
  version: '1.0',
  apiVersion: '1.0'                                // 添加 API 版本
};
